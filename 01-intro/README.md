...
Note: we will use Ansible version 14.3.1 (`ansible-core` version 2.21.3) for this course.
Teachers will have this version installed and use it to check your tasks.
Your code is considered working only if it executes successfully on Ansible 14.3.1.
...
For Linux or OS X, we recommend to use Python virtual env:
    ...
    ~/ansible-venv/bin/pip install ansible==14.3.1
